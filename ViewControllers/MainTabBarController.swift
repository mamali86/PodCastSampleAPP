...
//        perform(#selector(maximisePlayerDetails), with: nil, afterDelay: 1)
    ...
    func setupViewControllers() {
        ...
        viewControllers = [generateNavigationController(for: PodCastsSearchController(), image: #imageLiteral(resourceName: "search"), title: "Search"),
            generateNavigationController(for: favouritesViewController, image: #imageLiteral(resourceName: "favorites"), title: "Favourites"),  generateNavigationController(for: DownloadController(), image: #imageLiteral(resourceName: "downloads"), title: "Downloads")]
    }
